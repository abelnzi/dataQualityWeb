...
import  {getIndicatorsID,getMetadata,getGraphDataG1,transformDataG1,getGraphDataG2,transformDataG2,getGraphDataG3} from '../service/ServiceDataGraph'
...
const GraphsData = (props) => {
    ...
    const groupeIndicator1 = async (listElements,groupeId) => {
        ...
        if(listUIDG1!=""){
            var group1Data1=await getGraphDataG1(listUIDG1,props.orgUnit,props.period)
            //console.log("===========group1Data=========="+JSON.stringify(group1Data1))
            var dataG1=await transformDataG1(group1Data1)
            ...
            var group1Data2=await getGraphDataG2(listUIDG1,props.orgUnit,props.period)
            var dataG2=await transformDataG2(group1Data2)
            ...
            var group1Data3=await getGraphDataG3(listUIDG1,props.orgUnit,props.period)
            var dataG3=await transformDataG1(group1Data3)
        ...
        let group=await listElements.groups.filter(elt=> elt.code===groupeId)
    ...
    const groupeIndicator2 = async (listElements,groupeId) => {
        var listUIDG1=getIndicatorsID(listElements,groupeId)
        await console.log("===========G2 listUIDG1=========="+JSON.stringify(listUIDG1))
        var dataGraph=new Object()
        ...
        if(listUIDG1!=""){
            ...
            var group1Data2=await getGraphDataG2(listUIDG1,props.orgUnit,props.period)
            await console.log("===========G2 group2Data=========="+JSON.stringify(group1Data2))
            var dataG2=await transformDataG2(group1Data2)
            await console.log("===========G1 dataG2=========="+JSON.stringify(dataG2))
            dataGraph.headers2=await dataG2.headers
            dataGraph.series2=await dataG2.series
    ...
    return ( 
        <>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers11} series={series11} name={name1} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers12} series={series12} name={name1} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers13} series={series13} name={name1} period={props.period}/>
                </Grid>                 
            </Grid>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers21} series={series21} name={name2} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers22} series={series22} name={name2} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers23} series={series23} name={name2} period={props.period}/>
                </Grid>                 
            </Grid>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers31} series={series31} name={name3} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers32} series={series32} name={name3} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers33} series={series33} name={name3} period={props.period}/>
                </Grid>                 
            </Grid>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers41} series={series41} name={name4} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers42} series={series42} name={name4} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers43} series={series43} name={name4} period={props.period}/>
                </Grid>                 
            </Grid>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers51} series={series51} name={name5} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers52} series={series52} name={name5} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers53} series={series53} name={name5} period={props.period}/>
                </Grid>                 
            </Grid>
            ...
            <Grid container spacing={2}>                            
                <Grid item xs={4} >
                      <Graph headers={headers61} series={series61} name={name6} period={props.period}/> 
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers62} series={series62} name={name6} period={props.period}/>
                </Grid>
                <Grid item xs={4}>
                    <Graph headers={headers63} series={series63} name={name6} period={props.period}/>
                </Grid>                 
            </Grid>
