...
export const getGraphDataG1 = async (listUID,uidOU,period) => {
    ...
    var endpoint="analytics?dimension=ou:"+level+";"+uid+"&dimension=dx:"+listUID+"&filter=pe:"+period
...
export const getGraphDataG2 = async (listUID,uidOU,period) => {
    ...
    var endpoint="analytics?dimension=dx:"+listUID+"&dimension=ou:"+level+";"+uid+"&filter=pe:"+period
...
export const getGraphDataG3 = async (listUID,uidOU,period) => {
    ...
    var endpoint="analytics?dimension=ou:"+uid+"&dimension=dx:"+listUID+"&filter=pe:"+period
